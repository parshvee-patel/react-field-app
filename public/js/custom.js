...
(function ($) {
  ...
  THE.OnePage = function () {
    $(
      'header a[href*="#"]:not([href="#"]), .go-to a[href*="#"]:not([href="#"]), a.mouse[href*="#"]:not([href="#"])'
    ).on("click", function () {
      if (
  ...
  THE.pieChart = function () {
    ...
    if ($Pie_Chart.exists()) {
      loadScript(
        plugin_track + "easy-pie-chart/jquery.easypiechart.min.js",
        function () {
  ...
  THE.CountTimer = function () {
    if ($count_timer.exists()) {
      loadScript(
        plugin_track + "count-down/jquery.countdown.min.js",
        function () {
  ...
  $(window).on("scroll", function () {
    THE.ProgressBar(), THE.HeaderFixd();
  });
  ...
  $(document).on("click", function (e) {
    ...
    if (
      !$(e.target).closest(".cs-dropdown").length &&
